...
// Define translations for static texts in Basic component
const translations = {
  'English': {
...
const spices = [
  {
    ...
    translations: {
      'Hindi': "केसर के धागे", // Kesar ke dhaage
      'Bengali': "জাফরান সুতা" // Zafran suta
    }
  },
  {
    ...
    translations: {
      'Hindi': "टेलिचेरी काली मिर्च", // Telicherry Kali Mirch
      'Bengali': "টেলিচেরি কালো গোলমরিচ" // Telicheri Kalo Golmorich
    }
  },
  {
  ...
  },
  {
    ...
    translations: {
      'Hindi': "काला तिल", // Kala Til
      'Bengali': "কালো তিল" // Kalo Til
    }
  },
  {
    ...
    translations: {
      'Hindi': "गुलाबी मिर्च", // Gulabi Mirch
      'Bengali': "গোলাপী গোলমরিচ" // Golapi Golmorich
    }
  },
  {
    name: "Paprika", price: 18, img: "https://images.unsplash.com/photo-1669863347362-1630fe821708?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG0to-pYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    translations: {
      'Hindi': "पपरिका", // Paprika
      'Bengali': "পেপারিকা" // Peparika
    }
  },
  {
  ...
  },
  {
    ...
    translations: {
      'Hindi': "দালচিনি", // Dalchini
      'Bengali': "দারচিনি" // Darchini
    }
  },
];

// Basic now receives currentLanguage as a prop
export default function Basic({ onAddToCart, currentLanguage }) {
  ...
  const handleBuyNowClick = (product) => {
    const translatedMessage = translations[currentLanguage]?.proceedToBuy || translations['English'].proceedToBuy;
    console.log(`${translatedMessage}:`, product.name, "for ₹", product.price.toFixed(2));
    alert(`${translatedMessage} ${product.name}!`);
  };
  ...
  return (
    <main className="basic-main">
      <h2 className="basic-heading">
        {getTranslatedButtonText('vendorHeading')} {/* Translate "Vendor" heading */}
      </h2>
          ...
          <div key={idx} className="spice-card">
            ...
            <div className="button-group">
              <button className="add-to-cart-btn" onClick={() => handleAddToCartClick(item)}>
                {getTranslatedButtonText('addToCart')} {/* Translate "Add to Cart" */}
              </button>
              <button className="buy-now-btn" onClick={() => handleBuyNowClick(item)}>
                {getTranslatedButtonText('buyNow')} {/* Translate "Buy Now" */}
              </button>
            </div>
          </div>
        ))}
